...
// parametros iniciais do alvo, onde o primeiro fantasma aparecerá
const alvo = {
    x: 320,
    y: 320,
};
...
function atualizarPacman() {
    ...
    // remove células do pacman se ele estiver maior que o tamanho máximo
...
function moverPacman() {
    ...
    // adiciona a direção direita ou esquerda atual posição do pacman
    pacman.x += pacman.dx;
